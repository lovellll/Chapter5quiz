// Chapter5quiz.cpp : 定义控制台应用程序的入口点。
//
...
int main()
{
	...
	int nowSecond = 0;
	while (calculateHeight(initialHeight, nowSecond) > 0)
	{
		calculateAndPrintHeight(initialHeight, nowSecond);
		++nowSecond;
	}
	if (calculateHeight(initialHeight, nowSecond) <= 0)
		calculateAndPrintHeight(initialHeight, nowSecond);
